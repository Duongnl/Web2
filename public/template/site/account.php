      ...
      ?>
        ...
        <form action="../site/controller/account_controller.php" method="POST" id="account_form" class="account-profile-section">
          ...
          <div class="account-profile-contact-item">
              ...
              <input type="date" class="account-profile-contact-value" id="user_date" name="user_date" value="<?php echo  $row['ThoiGian'] ?>"></input>
            </div>
          
            <!-- quyen -->
            <div class="account-profile-contact-item">
              <label class="account-profile-contact-label">Permission</label>
              <input type="text" class="account-profile-contact-value" id="user_permission" name="user_permission" value="<?php echo  $row['TenQuyen'] ?>"></input>
            </div>
        ...
        <form action="" method="POST" id="account_form_2" class="account-profile-section">
          ...
          <label class="account-profile-name-label">User Name</label>
          <input type="text" class="account-profile-password-input" placeholder="User name" id="username" name="username" value="<?php echo  $row['TenTK'] ?>"></input>
          <label class="account-profile-name-label">Email</label>
          <input type="text" class="account-profile-password-input" placeholder="Email" id="email" name="email" value="<?php echo  $row['Email'] ?>"></input>
          <label class="account-profile-name-label">Password</label>
          <input type="password" class="account-profile-password-input" placeholder="Password" id="password" name="password" value="<?php echo  $row['MatKhau'] ?>"></input>
          <label class="account-profile-name-label">New Password</label>
          <input type="password" class="account-profile-password-input" placeholder="New Password" id="newpassword" name="newpassword"></input>
          <label class="account-profile-name-label">Confirm New Password</label>
          <input type="password" class="account-profile-password-input" placeholder="Confirm New Password" id="cf_password" name="cf_password"></input>
